...
<body>
    ...
    <div class="home-glass">
        <div class="header-content">
            ...
            <span style="color: #fff; margin-right: 10px;"><?php echo htmlspecialchars($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?>!</span>
        ...
        <table class="user-table">
            ...
            <tbody id="userTableBody">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-action btn-edit" style="width: 100px;" onclick="openEditModal(<?php echo (int)$user['id']; ?>, <?php echo json_encode($user['username']); ?>, <?php echo json_encode($user['role']); ?>)">
    ...
    <script>
        ...
        // Sanitize back link: allow only same-site relative paths
        $(function() {
            try {
